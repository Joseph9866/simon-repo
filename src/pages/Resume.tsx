        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-12">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 mb-8">
              <div>
                <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-2">JANE DOE</h1>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-12 pb-12 border-b border-gray-200">
              <div className="flex items-center gap-3 text-gray-700">
                ...
                <a href="mailto:hello@janedoe.com" className="hover:text-gray-900 transition-colors">
                  hello@janedoe.com
                </a>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
